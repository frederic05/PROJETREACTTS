//importation de ma class de typage
import {Project} from './datainterface';

export const CurrenteData = [
    new Project({
        id: 1,
        name: 'Johnson - Kutch',
        description:'Fully-configurable intermediate framework. Ullam occaecati libero laudantium nihil voluptas omnis.',
        imageUrl: 'https://www.zapwallpaper.fr/blog/wp-content/uploads/2017/11/service_en_ligne-678x381.png',
        contractTypeId: 3,
      ...
      new Project({
        ...
        imageUrl: 'https://graphiste.com/blog/wp-content/uploads/2021/11/outils-redimensionner-image-en-ligne.jpg.webp',
        contractTypeId: 4,
      ...
      new Project({
        ...
        imageUrl: 'https://thumbs.dreamstime.com/z/programmeur-de-d%C3%A9veloppement-professionnel-fonctionnant-dans-le-websi-programmation-132331729.jpg',
        contractTypeId: 6,
      ...
      new Project({
        ...
        imageUrl: 'https://thumbs.dreamstime.com/z/informaticien-femelle-fonctionnant-%C3%A0-son-bureau-128115827.jpg',
        contractTypeId: 4,
      ...
      new Project({
        ...
        imageUrl: 'https://media.istockphoto.com/photos/and-programming-development-technology-picture-id1050561910',
        contractTypeId: 2,
